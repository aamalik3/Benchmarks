...
HD_PWD='C:/Users/aamalik3/Desktop/ICAP_Readback/ONRHandover/BaseProject/BaseProject.runs/design_1_CUSTOM_IPS_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_CUSTOM_IPS_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_CUSTOM_IPS_0_0.tcl
