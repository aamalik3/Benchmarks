...
proc create_root_design { parentCell } {
  ...
  # Create instance: CLK_Gate_0, and set properties
  set block_name CLK_Gate
  set block_cell_name CLK_Gate_0
  if { [catch {set CLK_Gate_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $CLK_Gate_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: CUSTOM_IP, and set properties
  set block_name CUSTOM_IPS
  set block_cell_name CUSTOM_IP
  if { [catch {set CUSTOM_IP [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $CUSTOM_IP eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: CUSTOM_IP_PASS, and set properties
  set CUSTOM_IP_PASS [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 CUSTOM_IP_PASS ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins CUSTOM_IP_PASS/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net CUSTOM_IPS_0_Output_Bus [get_bd_pins CUSTOM_IP/Output_Bus] [get_bd_pins CUSTOM_IP_PASS/gpio_io_i]
  connect_bd_net -net CUSTOM_IP_Output_1 [get_bd_ports LD] [get_bd_pins CUSTOM_IP/Output_1]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_ports GLED] [get_bd_pins STARTUP_0/GSR_i] [get_bd_pins axi_gpio_0/gpio_io_o]
  connect_bd_net -net enb_1 [get_bd_ports enb] [get_bd_pins CLK_Gate_0/enb]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins CUSTOM_IP_PASS/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins CLK_Gate_0/clk_i] [get_bd_pins CUSTOM_IP/clock] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_1 [get_bd_ports rst] [get_bd_pins CUSTOM_IP/reset]
  connect_bd_net -net rst_ps7_0_50M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_50M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins CUSTOM_IP_PASS/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins CUSTOM_IP_PASS/gpio2_io_i] [get_bd_pins xlconstant_0/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41210000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs CUSTOM_IP_PASS/S_AXI/Reg] SEG_sha_digest_Reg
