...
proc create_root_design { parentCell } {
  ...
  # Create instance: GSR_GPIO, and set properties
  set GSR_GPIO [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 GSR_GPIO ]
  set_property -dict [ list \
   CONFIG.C_ALL_OUTPUTS {1} \
   CONFIG.C_GPIO_WIDTH {1} \
 ] $GSR_GPIO

  # Create instance: RISC_BENCHMARK_IP, and set properties
  set block_name RISC_BENCHMARK_IP
  set block_cell_name RISC_BENCHMARK_IP
  if { [catch {set RISC_BENCHMARK_IP [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $RISC_BENCHMARK_IP eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: RISC_IP_CHECK, and set properties
  set RISC_IP_CHECK [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 RISC_IP_CHECK ]
  set_property -dict [ list \
  ...
  # Create instance: STARTUP, and set properties
  set block_name STARTUP
  set block_cell_name STARTUP
  if { [catch {set STARTUP [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $STARTUP eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins GSR_GPIO/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins RISC_IP_CHECK/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net RISC_AES_result_vld [get_bd_ports led] [get_bd_pins RISC_BENCHMARK_IP/result_vld] [get_bd_pins RISC_IP_CHECK/gpio2_io_i]
  connect_bd_net -net RISC_BENCHMARK_IP_MSB_Bits [get_bd_pins RISC_BENCHMARK_IP/MSB_Bits] [get_bd_pins RISC_IP_CHECK/gpio_io_i]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_ports GLED] [get_bd_pins GSR_GPIO/gpio_io_o] [get_bd_pins STARTUP/GSR_i]
  connect_bd_net -net enb_1 [get_bd_ports enb] [get_bd_pins RISC_BENCHMARK_IP/cpu_start]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins GSR_GPIO/s_axi_aclk] [get_bd_pins RISC_IP_CHECK/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins RISC_BENCHMARK_IP/clk] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_1 [get_bd_ports rst] [get_bd_pins RISC_BENCHMARK_IP/cpu_rst]
  connect_bd_net -net rst_ps7_0_50M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_50M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins GSR_GPIO/s_axi_aresetn] [get_bd_pins RISC_IP_CHECK/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs GSR_GPIO/S_AXI/Reg] SEG_axi_gpio_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41210000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs RISC_IP_CHECK/S_AXI/Reg] SEG_sha_digest_Reg
