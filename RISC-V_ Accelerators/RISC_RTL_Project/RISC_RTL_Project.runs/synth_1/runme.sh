...
HD_PWD='C:/Users/aamalik3/Desktop/ICAP_Readback/Benchmarks/RISC_RTL_Project/RISC_RTL_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RISC_BENCHMARK_IP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RISC_BENCHMARK_IP.tcl
